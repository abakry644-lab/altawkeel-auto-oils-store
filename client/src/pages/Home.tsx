...
export default function Home() {
  ...
  return <div>
    ...
    <section id="offers" className="offer-band relative overflow-hidden bg-[#163d36] py-14 text-white sm:py-16"><div className="container relative grid gap-8 md:grid-cols-[1fr_auto] md:items-center"><div><p className="text-xs font-extrabold tracking-[.15em] text-[#e6b970]">ميزة التوكيل</p><h2 className="mt-2 text-3xl font-extrabold">شحن مجاني لما فوق 500 جنيه.</h2><p className="mt-3 max-w-2xl text-sm leading-7 text-[#c8d3cf]">اجمع احتياجات الصيانة في طلب واحد، ثم أدخل بيانات التوصيل خلال صفحة إتمام الطلب الآمنة.</p></div><Link href="/shop" className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#d9a553] px-5 py-3.5 text-sm font-extrabold text-[#173b33] transition hover:bg-[#ecc57e]">تسوّق الآن <ArrowLeft size={18} /></Link></div></section>
