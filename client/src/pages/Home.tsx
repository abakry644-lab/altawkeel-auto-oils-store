...
export default function Home() {
  ...
  return <div>
    <section className="relative overflow-hidden border-b border-[#e9e3d9] bg-[#f3f0e9]">
      <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full bg-[#d8b274]/25 blur-3xl" />
      <div className="absolute -bottom-36 left-[10%] h-80 w-80 rounded-full bg-[#2c6153]/15 blur-3xl" />
      <div className="container relative grid items-center gap-12 py-16 sm:py-24 lg:grid-cols-[1.05fr_.95fr] lg:py-28">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-[#dcccae] bg-[#fffaf0] px-3 py-1.5 text-xs font-extrabold text-[#9f6c27]"><Sparkles size={14} /> اختيار مدروس لسيارتك</div>
        ...
        <div className="relative mx-auto w-full max-w-md"><div className="absolute -inset-4 rounded-[2.5rem] border border-white/50 bg-white/35" /><div className="relative overflow-hidden rounded-[2rem] bg-[#d8d0c2] p-4 shadow-[0_28px_70px_rgba(23,59,51,.22)]"><img src="/manus-storage/engine-oil-premium_be3b91a4.png" alt="زيت محرك تخليقي" className="aspect-[4/5] w-full rounded-[1.5rem] object-cover" /><div className="absolute bottom-8 right-8 rounded-2xl bg-[#fffdf9]/95 px-4 py-3 shadow-xl backdrop-blur"><p className="text-[10px] font-extrabold tracking-wide text-[#a0702f]">اختيار هذا الأسبوع</p><p className="mt-1 text-sm font-extrabold text-[#183c34]">زيت محرك تخليقي</p></div></div></div>
      </div>
    </section>
    ...
    <section id="offers" className="bg-[#163d36] py-14 text-white sm:py-16"><div className="container grid gap-8 md:grid-cols-[1fr_auto] md:items-center"><div><p className="text-xs font-extrabold tracking-[.15em] text-[#e6b970]">ميزة أوتو زون</p><h2 className="mt-2 text-3xl font-extrabold">شحن مجاني لما فوق 500 جنيه.</h2><p className="mt-3 max-w-2xl text-sm leading-7 text-[#c8d3cf]">اجمع احتياجات الصيانة في طلب واحد، ثم أدخل بيانات التوصيل خلال صفحة إتمام الطلب الآمنة.</p></div><Link href="/shop" className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#d9a553] px-5 py-3.5 text-sm font-extrabold text-[#173b33] transition hover:bg-[#ecc57e]">تسوّق الآن <ArrowLeft size={18} /></Link></div></section>
