...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="grid h-11 w-11 place-items-center rounded-full bg-white text-[#1da851] shadow-sm"><MessageCircle size={23} fill="currentColor" strokeWidth={1.8} /></span>
    </a>
  );
}
